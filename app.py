...
# Demo credentials (in a real app, store these securely)
# Username: admin, Password: password123
credentials = {
    "admin": "ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f"  # hashed "password123"
}

# Login Page
def login_page():
    st.title("Login to Nickel Mining Dashboard")
